...
class $c_Ltutorial_webapp_TutorialApp$ extends $c_O {
  constructor() {
    ...
    this.Ltutorial_webapp_TutorialApp$__f_cellCountPerRow = 700;
    this.Ltutorial_webapp_TutorialApp$__f_cellSizeInPixels = 1
  };
  main__AT__V(args) {
  ...
  getCanvas__Lorg_scalajs_dom_raw_Node__V(targetNode) {
    ...
    simulationCanvas.setAttribute("width", ($imul(this.Ltutorial_webapp_TutorialApp$__f_cellCountPerRow, this.Ltutorial_webapp_TutorialApp$__f_cellSizeInPixels) + "px"));
    simulationCanvas.setAttribute("height", ($imul(this.Ltutorial_webapp_TutorialApp$__f_cellCountPerRow, this.Ltutorial_webapp_TutorialApp$__f_cellSizeInPixels) + "px"));
    ...
    ctx.fillStyle = "grey";
    ctx.fillRect(0.0, 0.0, $imul(this.Ltutorial_webapp_TutorialApp$__f_cellCountPerRow, this.Ltutorial_webapp_TutorialApp$__f_cellSizeInPixels), $imul(this.Ltutorial_webapp_TutorialApp$__f_cellCountPerRow, this.Ltutorial_webapp_TutorialApp$__f_cellSizeInPixels));
    ctx.fillStyle = "black";
    const down = new $c_sr_BooleanRef(false);
    canvas.onkeydown = ((arg1$2) => $m_Ltutorial_webapp_TutorialApp$().tutorial$webapp$TutorialApp$$$anonfun$getCanvas$1__Lorg_scalajs_dom_raw_KeyboardEvent__O(arg1$2));
    canvas.onkeyup = ((down$1) => ((arg1$2$1) => {
      $m_Ltutorial_webapp_TutorialApp$().tutorial$webapp$TutorialApp$$$anonfun$getCanvas$3__Lorg_scalajs_dom_raw_KeyboardEvent__sr_BooleanRef__V(arg1$2$1, down$1)
    }))(down)
  };
  tutorial$webapp$TutorialApp$$$anonfun$getCanvas$1__Lorg_scalajs_dom_raw_KeyboardEvent__O(e) {
    const x1 = $uI(e.keyCode);
    return ((x1 === 13) ? ($m_Ltutorial_webapp_TutorialApp$().appendPar__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Hello World"), (void 0)) : $m_s_None$())
  };
  tutorial$webapp$TutorialApp$$$anonfun$getCanvas$3__Lorg_scalajs_dom_raw_KeyboardEvent__sr_BooleanRef__V(e, down$1) {
